...
import 'package:neoncave_arena/screens/auth/change_password/view_model/change_password_view_model.dart';
...
class ChangePasswordScreen extends StatelessWidget {
  ...
  Future<void> _changePassword(
    ChangePasswordViewModel provider,
  ...
  bool _validateInputs(ChangePasswordViewModel provider, BuildContext context) {
    ...
    if (oldPassword.isEmpty) {
      provider.updateCurrentPasswordError(
        true,
        LocaleKeys.oldPasswordEmpty.tr(),
      );
      return false;
    }
    ...
    bool hasSpecialCharacter = newPassword.contains(
      RegExp(r'[!@#$%^&*(),.?":{}|<>]'),
    );
    ...
    if (!hasCapitalLetter) {
      provider.updateNewPasswordError(
        true,
        LocaleKeys.atLeastOneUppercase.tr(),
      );
      return false;
    }
    ...
    if (confirmPassword.isEmpty) {
      provider.updateConfirmPasswordError(
        true,
        LocaleKeys.confirmPasswordEmpty.tr(),
      );
      return false;
    }
    ...
    if (oldPassword == newPassword) {
      provider.updateNewPasswordError(
        true,
        LocaleKeys.newPasswordSameAsOld.tr(),
      );
      return false;
    }
  ...
  Widget build(BuildContext context) {
    final provider = Provider.of<ChangePasswordViewModel>(context);
    return Scaffold(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
              LocaleKeys.updatePasswordText.tr(),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildRequirementRow(
            ...
            LocaleKeys.atLeast8Characters.tr(),
          ),
          _buildRequirementRow(
            Icons.check_circle_outline,
            LocaleKeys.atLeastOneUppercase.tr(),
          ...
          _buildRequirementRow(
            Icons.check_circle_outline,
            LocaleKeys.atLeastOneNumber.tr(),
          ),
          _buildRequirementRow(
            Icons.check_circle_outline,
            LocaleKeys.atLeastOneSpecialCharacter.tr(),
