...
import 'package:neoncave_arena/screens/create_organization/view/basic_form_view.dart';
...
class _CreateOrganizationState extends State<CreateOrganization> {
  late final CreateOrganizationViewModel _provider;

  @override
  void initState() {
    super.initState();
    _provider = context.read<CreateOrganizationViewModel>();
  }
  ...
  Widget build(BuildContext context) {
    final organizationVm =
        Provider.of<CreateOrganizationViewModel>(context, listen: true);
    return Scaffold(
      backgroundColor: AppColor.screenBG,
      appBar: const CommonAppBar(title: LocaleKeys.createOrganization),
      body: SafeArea(
        child: Column(
          children: [
            // Progress indicator
