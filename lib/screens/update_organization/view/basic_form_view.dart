...
class UpdateOrganizationBasicForm extends StatelessWidget {
  const UpdateOrganizationBasicForm({super.key});
  @override
                ...
                children: [
                  Center(
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          CustomText(
                            title: LocaleKeys.updateYourOrganization.tr(),
                          ...
                          Gap.h(5),
                          CustomText(
                            title: LocaleKeys.updateYourOrganizationText.tr(),
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: (provider.imageLogoFilePath.isNotEmpty || provider.imageLogoNetworkUrl.isNotEmpty)
                              ? Colors.transparent
                              : AppColor.offwhite,
                          border: Border.all(
                            width: 1,
                        ...
                        child: provider.imageLogoFilePath.isNotEmpty
                            ? ClipRRect(
                                borderRadius: BorderRadius.circular(100),
                                child: Image.file(
                                  File(provider.imageLogoFilePath),
                                  fit: BoxFit.cover,
                                ),
                              )
                            : provider.imageLogoNetworkUrl.isNotEmpty
                                ? ClipRRect(
                                    borderRadius: BorderRadius.circular(100),
                                    child: Image.network(
                                      provider.imageLogoNetworkUrl,
                                      fit: BoxFit.cover,
                                    ),
                                  )
                                : Column(
                  ...
                  Container(
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        child: provider.imageHeaderFilePath.isNotEmpty
                            ? ClipRRect(
                                borderRadius: BorderRadius.circular(12),
                                child: Image.file(
                                  File(provider.imageHeaderFilePath),
                                  fit: BoxFit.cover,
                                ),
                              )
                            : provider.imageHeaderNetworkUrl.isNotEmpty
                                ? ClipRRect(
                                    borderRadius: BorderRadius.circular(12),
                                    child: Image.network(
                                      provider.imageHeaderNetworkUrl,
                                      fit: BoxFit.cover,
                                    ),
                                  )
                                : Column(
                  ...
                  PopupMenuButton<String>(
                    ...
                    constraints: BoxConstraints(
                      maxHeight: AppConfig(context).width * .6,
